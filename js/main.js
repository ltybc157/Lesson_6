...
let budgetValue = document.getElementsByClassName('budget-value')[0]; //1
let daybudgetValue = document.getElementsByClassName('daybudget-value')[0]; //2
let levelValue = document.getElementsByClassName('level-value')[0]; //3
let expensesValue = document.getElementsByClassName('expenses-value')[0]; //4
let optionalexpensesValue = document.getElementsByClassName('optionalexpenses-value')[0]; //5
let incomeValue = document.getElementsByClassName('income-value')[0];
let monthsavingsValue = document.getElementsByClassName('monthsavings-value')[0]; //7
let yearsavingsValue = document.getElementsByClassName('yearsavings-value')[0]; //8
...
let persentValue = document.querySelector('.choose-percent');
